...
CREATE TABLE `cms_account` (
  ...
  CONSTRAINT `empid` FOREIGN KEY (`emp_id`) REFERENCES `employee` (`emp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `perid` FOREIGN KEY (`per_id`) REFERENCES `cms_permission` (`per_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
-- Dump completed on 2015-08-23 19:52:48
